...
//gboolean g_osx_app_info_get_show_in(GOsxAppInfo *info, const gchar *desktop_env); // doesn't exist
#define g_desktop_app_info_get_show_in(info, desktop_env) dummy_osx_app_info_get_show_in(info, desktop_env)

static gboolean dummy_osx_app_info_get_show_in(GOsxAppInfo *info, const gchar *desktop_env)
{
	g_warning("Using dummy_osx_app_info_get_show_in(GOsxAppInfo *info, const gchar *desktop_env)");
	return 0;
}
